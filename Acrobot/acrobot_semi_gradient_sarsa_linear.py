...
for episode in range(num_episodes):
	...
	while(True):
		...
		active_tiles = tiles(iht, NUM_TILES, np.multiply(state, [1.5, 1.5, 1.5, 1.5, 1.5/12.566371, 1.5/28.274334]), [action])
...
plt.xlabel('Episodes')
plt.savefig('Acrobot-v1_semi_gradient_sarsa_linear.png')
plt.show()
env.close()